  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-8">
        ...
        <h1 style={{ color: '#e8e8f0', fontFamily: 'Syne, sans-serif' }} className="text-2xl font-semibold">Modifier la facture</h1>
      </div>
      <InvoiceForm invoice={invoice} basePath="/comptable/factures" />
    </div>
  )
}
